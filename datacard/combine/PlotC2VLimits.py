...
output_dir = "/home/users/{0}/public_html/vbs/limits/".format(os.getenv("USER"))
os.makedirs(output_dir, exist_ok=True)

canv.SaveAs(output_dir+"/"+channel+"_C2V_Limit_"+wp+".png")
canv.SaveAs(output_dir+"/"+channel+"_C2V_Limit_"+wp+".pdf")
